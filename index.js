...
function sayHiToGrandma(string) {if(string === 'hello') return "I can\'t hear you!"; else if (string==='HELLO') return "YES INDEED!"; else if(string === "I love you, Grandma.") return  "I love you, too." }
