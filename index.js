...
function sayHiToGrandma(string) {if(string === 'I love you, Grandma.') {return 'I love you, too.'} else if(string === string.toUpperCase()) {return 'YES INDEED!'} else {return 'I can\'t hear you!'}}
